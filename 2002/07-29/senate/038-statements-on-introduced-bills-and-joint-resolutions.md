---
granule: CRECB-2002-pt11-Pg15179
date: 2002-07-29
edition: CRECB
section: SENATE
page: 15179
...
not to be Federal responsibility became a Federal necessity. Now we are 
faced with a near crisis situation.
...
and wastewater infrastructure statutes and exploring needed 
...
the Record, as follows:
     ...
     for gas-fired units serving one or more generators with total 
     nameplate capacity of 25 MW of less and certain new 
     ...
     oxides and in Sections 461-465 the

[[Page 15182]]

     requirements of the existing NO<INF>X</INF> State 
     Implementation (SIP) call under Section 110 of the Clean Air 
     Act through December 31, 2007; and contains in Sections 451-
     454 the new, annual caps on total allowances and new, 
     ...
     trade systems are established for Zone 1 (largely the eastern 
     and part of the central portions of the U.S.) and Zone 2 (the 
     remainder of the U.S. and territories).
     ...
     facility.
       Under Section 453, annual NO<INF>X</INF> emissions for 
     ...
     emission reduction requirements of the NO<INF>X</INF> SIP 
     Call that covers the eastern U.S. The SIPs are required to be 
     consistent with the NO<INF>X</INF> emission budgets 
     established under the NO<INF>X</INF> SIP Call. SIPs must be 
     ...
     limits for four pollutants: nitrogen oxides (NO<INF>X</INF>); 
     sulfur dioxide (SO<INF>2</INF>); mercury (Hg); and 
     ...
     similar to current NSPS.
       Boilers and IGCCs are subject to a SO<INF>2</INF> emission 
     limit of 2.0 lb/MWh; a NO<INF>X</INF> emission limit of 1.0 
     ...
     the same NO<INF>X</INF>, SO<INF>2</INF>, PM, and Hg emission 
     limits as boilers and IGCCs. Oil-fired combustion turbines 
     are subject to NO<INF>X</INF> emission limits ranging from 
     0.289 lb/MWh to 1.01 lb/MWh, an SO<INF>2</INF> emission limit 
     of 2.0 lb/MWh, and a PM emission limit of 0.20 lb/MWh. Gas-
     fired combustion turbines are subject to NO<INF>X</INF> 
     ...
     NO<INF>X</INF>, SO<INF>2</INF>, PM, and CO specified in 
     ...
     NO<INF>X</INF>, SO<INF>2</INF>, PM, and CO established in 
...
Sec. 3. Other amendments.
     ...
     comprising at least ninety percent, and fuel oil comprising 
...
[[Page 15184]]
     ...
     the auction from which it was taken under subparagraph

[[Page 15185]]

     (D) or a subsequent relevant auction as necessary.
     ...
     quality assure the data, for sulfur dioxide, nitrogen oxides, 
...
[[Page 15186]]
     ...
     for that calendar year shall be liable for the payment of an 
     ...
     Skies Act of 2002. Any such payment shall be deposited in the 
...
[[Page 15187]]
     ...
     the excess emissions by an equal amount of tons in the 
     following calendar year, or such longer period as the 
     Administrator may prescribe. The Administrator shall deduct 
     sulfur dioxide allowances equal to the excess emissions in 
     tons from those held for the facility for the year, or 
...
[[Page 15188]]
     ...
     than 98 percent, (3) is equipped with low-NO<INF>X</INF> 
     burners prior to the time of commencement, and (4) is 
     otherwise in compliance with the requirements of this Act.
     ...
     specified numbers of allowances at specified prices. 
     Allowances purchased at the auction may be used for any 
     purpose and at any time after the auction, subject to the 
     ...
     price, the Administrator shall sell the amount of remaining 
     allowances to the person who submitted that bid.
     ...
     given the available control technologies and the ability to 
     install control technologies by 2018, and the feasibility of 
     attaining alternative limitations on the total annual amounts 
     of allowances available starting in 2018 under paragraph 
     (a)(1) for each pollutant, including the ability to achieve 
...
[[Page 15189]]
     ...
     affects on terrestrial or aquatic systems as opposed to the 
     contribution from affected EGUs under part D, and the extent 
     to which effective mercury control programs in other 
     ...
     nitrogen oxides, or mercury at any time after the study has 
     been completed under paragraph (a)(2) and the peer review 
     process has been completed under subsection (b).
...
[[Page 15191]]
     ...
     to such unit have been achieved pursuant to subsection (b) or 
     (d), or (B) the owner or operator of such unit holds 
     allowances to emit not less than the unit's total annual 
     emissions, except that, after January 1, 2000, the emissions 
     limitations established in this section shall be superseded 
     by those established in section 414. The owner or operator of 
     any unit in violation of this section be fully liable for 
     such violation including, but not limited to, liability for 
...
[[Page 15194]]
     ...
     measures for any calendar year shall be a tonnage equal to 
     ...
     1985 emission rate equal to, or greater than, 1.20 lbs/

[[Page 15195]]

     mmBtu and which is a unit owned by a utility operating 
     company whose aggregate nameplate fossil fuel steam-electric 
     capacity is, as of December 31, 1989, equal to, or greater 
     than, 250 MWe to exceed an annual sulfur dioxide emissions 
     limitation equal to the product of the unit's baseline 
     multiplied by an emission rate equal to 1.20 lbs/mmBtu, 
     divided by 2,000 unless the owner or operator of such unit 
     holds allowances to emit not less than the unit's total 
     annual emissions or, for a year after 2007, unless the owner 
     or operator of the source that includes such unit holds 
     ...
     120 percent, divided by 2,000, unless the owner or operator 
     of such unit holds allowances to emit not less than the 
     unit's total annual emissions or, for a year after 2007, 
     unless the owner or operator of the source that includes such 
     unit holds allowances to emit not less than the total annual 
     emissions of all affected units at the source.
...
[[Page 15196]]
  ...
  Malakoff 1......................................................1,759
     ...
     of 40,000. If necessary to meeting the

[[Page 15197]]

     40,000 allowance restriction imposed under this subsection 
     ...
     allowance at specified prices. Such regulations shall specify 
     that the auctioned allowances shall be allocated and sold on 
     the basis of bid price, starting with the highest-priced bid 
     and continuing until all allowances for sale at such auction 
     have been allocated. The regulations shall not permit that a 
     minimum price be set for the purchase of withheld allowances. 
     Allowances purchased at the auction may be used for any 
     purpose and at any time after the auction, subject to the 
     provisions of this subpart and subpart 2.
...
------------------------------------------------------------------------
     ...
     SEC. 418. INDUSTRIAL SO<INF>2</INF> EMISSIONS.
...
------------------------------------------------------------------------
     ...
     thereafter and are held in unit accounts and general accounts 
     in the Allowance Tracking System under section 403(c).
...
[[Page 15201]]
     ...
     section 413(d), must meet the SO<INF>2</INF> reduction 
     ...
     NO<INF>X</INF> burned technology is available: Provided, 
     ...
     NO<INF>X</INF> burners. Nothing in this section shall 
     preclude an owner or operator from installing and operating 
     an alternative NO<INF>X</INF> control technology capable of 
...
[[Page 15203]]
     ...
     Tracking System for nitrogen oxides allowances, by July 1 
     that is eighteen months before January 1 of such year, then 
     it shall be unlawful for an affected EGU in the Zone 1 States 
     to emit nitrogen oxides during such year in excess of 0.14 
     lb/mmBtu.
...
Accountability; Major Source Preconstruction Review and Best Available 
     ...
     under subparagraph (1)(D) if they are

[[Page 15205]]

     constructed as part of a demonstration project under the 
     Secretary of Energy that will include a demonstration of 
     removal of significant amounts of mercury as determined by 
     the Secretary of Energy in conjunction with the Administrator 
...
[[Page 15206]]
     ...
     the cost and feasibility of technologies. Such information 
     shall be included in the report under subsection (d). In 
...
[[Page 15207]]
     ...
     will attain that standard no later than December 31, 2015, 
     and such modeling demonstration and all necessary local 
     controls have been approved into the state implementation 
     plan no later than December 31, 2004.''; and
     ...
     use the best available peer reviewed models and methodology 
     that consider the proximity of the source or sources to the 
     petitioning State or political subdivision and incorporate 
     ...
     Provided, however, that electric utility steam generating 
     units not subject to Resource Conservation and Recovery Act 
     section 3005 shall not be included in any category or 
     subcategory listed under this subsection. The Administrator 
     shall have the authority to regulate the emission of 
     hazardous air pollutants listed under section 112(b), other 
     than mercury compounds, by electric utility steam generating 
     units in accordance with the regime set forth in section 
     112(f)(2) through (4). The section 112(f)(2) determination 
     shall be based on actual emissions by electric utility steam 
     generating units in 2010. Any such regulations shall be 
     promulgated within 8 years of 2010. To the extent 
     ...
     Act of 2002 seeks a finding for any affected unit, then, 
     ...
     proximity of the source or sources

[[Page 15208]]

     to the petitioning State or political subsidision and 
...
higher on average. This proposal would provide an above the line 
deduction for overnight travel costs and would be available for all 
...
Sec. 8. Clarification of the treatment of dependent care assistance 
     ...
     military base realignment and closure fringe' means 1

[[Page 15210]]

     or more payments under the authority of section 1013 of the 
...
Doubling Act, because our intentions are simple and straightforward. 
...
NIH.
  The high-tech industry also is concerned about NSF funding because 
they

[[Page 15212]]

are struggling to find qualified homegrown engineers and scientists and 
becoming more reliant on foreign nationals to fill their positions. 
Many notable researchers in the high-tech industry have told me that 
the significant shortages of trained American engineers and scientists 
have limited the growth potential of the electronics and software 
industries and allowed foreign competitors to catch up to U.S. industry 
capabilities.
