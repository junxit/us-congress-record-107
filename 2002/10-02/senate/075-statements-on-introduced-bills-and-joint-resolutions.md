---
granule: CRECB-2002-pt14-Pg18892
date: 2002-10-02
edition: CRECB
section: SENATE
page: 18892
...
nurses. Our hospitals, doctors, nurses, and other

[[Page 18894]]

health care providers want to do the right thing. The bill gives the 
health care community the tools to identify the causes of medical 
errors, the resources to develop strategies to prevent them, and the 
encouragement to implement those solutions.
...
Record, as follows:
     ...
     at 200 West 2d Street in

[[Page 18895]]

     Dayton, Ohio, shall be known and designated as the ``Tony 
     Hall Federal Building and United States Courthouse''.
...
to expedite the project approval process and get construction underway 
faster.
...
on less than $1 a day. The legislation also provides that the 
microenterprise programs should target both rural and urban poor.
...
Record, as follows:
     ...
     Commission information that, by State, provides

[[Page 18899]]

     the minimum age at which it is legal under State law to 
