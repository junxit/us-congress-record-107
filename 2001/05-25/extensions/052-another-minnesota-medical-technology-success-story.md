---
granule: CRECB-2001-pt7-Pg9840-3
date: 2001-05-25
edition: CRECB
section: EXTENSIONS
page: 9840
...
are saving lives, improving the quality of life and reducing health 
...
other Americans who desperately need them.
     ...
     problems as loss of memory, confusion and inability to

[[Page 9841]]

     pay attention for as long as five years after the surgery. 
     About 3% of bypass patients suffer a debilitating stroke as a 
     ...
     same.''
       St. Jude isn't alone in seeing a big opportunity for such 
     ...
     Among other things, it is designed to eliminate the problem 
     of mismatched vessel diameters.
       Another model the company is developing would come into 
     play when doctors use the internal mammary artery, located in 
     the chest wall above the heart, as a bypass vessel. Surgeons 
     often use that artery for by-passing the artery that feeds 
     the heart's pumping chamber. Still another version of the 
     device is aimed at the growing number of surgeons who prefer 
     to use the radial artery taken from the arm as a bypass 
     vessel.
