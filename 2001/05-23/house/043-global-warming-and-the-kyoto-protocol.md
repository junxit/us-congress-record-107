---
granule: CRECB-2001-pt7-Pg9311-2
date: 2001-05-23
edition: CRECB
section: HOUSE
page: 9311
...
CO<INF>2</INF>, and this chart, I think, demonstrates why the United 
...
the amount of CO<INF>2</INF> emissions. The blue at the bottom displays 
the sequestration, or the sinks, how much of the CO<INF>2</INF> we 
...
CO<INF>2</INF> greatly exceeds the amount they sequester.
...
forestlands and our grasslands actually consumed CO<INF>2</INF> and 
that we could be a country that on a net basis emitted no 
CO<INF>2</INF> because we had large pinewood forests in the south and 
...
we reduce our CO<INF>2</INF> emissions, reduce our greenhouse gases, 
...
CO<INF>2</INF> that they are putting into the air. The blue at the 
bottom indicates how much they sequester or capture of CO<INF>2</INF>. 
And of course all living organisms live on CO<INF>2</INF>. Our plants 
...
amount of CO<INF>2</INF> as we emit. Unlike the European countries, as 
...
CO<INF>2</INF> just in case it might be causing a greenhouse gas out 
there.
...
minimize the CO<INF>2</INF> emissions, but a tremendous political 
...
emit CO<INF>2</INF>; and certainly the research to expand the 
sequestration of CO<INF>2</INF> must be encouraged.
...
pushing the kind of research that is going to reduce CO<INF>2</INF> 
emissions, but whether it is CO<INF>2</INF> or whether it is vapor 
