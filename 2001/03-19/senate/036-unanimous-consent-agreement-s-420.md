...
```
  ...
  Mr. LIEBERMAN. Mr. President, I ask unanimous consent that with 
respect to S. 420, amendments numbered 43, 54, and 66 be modified or 
further modified with the changes at the desk. These changes are needed 
to make technical corrections.
  ...
  The amendments, as modified, are as follows:
       ...
       On page 134, line 11 of amendment number 68, strike 
     ``discharge a debtor'' and insert ``discharge an individual 
     debtor''.
     ...
     Code, or any similar State statute,''.
       ...
       On page 13 of amendment number 68 strike line 1 and all 
     that follows through line 3, and insert the following:
     ...
     period.''.
       ...
       Strike line 1, page 22 to line 17, page 22 of amendment 
     number 68 and insert in lieu thereof--
       ``(f) An individual debtor in a case under chapter 7, 11, 
     or 13 shall file with the court at the request of the Judge, 
     U.S. Trustee, or any party in interest--
     ...
     transcripts thereof, described in paragraph (1) or (2); 
     and''.
